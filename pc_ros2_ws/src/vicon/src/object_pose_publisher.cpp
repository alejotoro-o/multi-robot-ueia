...
class MultiRobotPosePublisher : public rclcpp::Node
{
    ...
    rclcpp::Publisher<geometry_msgs::msg::Pose>::SharedPtr object_publisher;
    ...
    {   
        ...
        object_publisher = this->create_publisher<geometry_msgs::msg::Pose>("object/pose", 10);
    ...
    private: void timer_callback()
    {
        ...
        Output_GetSubjectName object3_name = this->vicon_client.GetSubjectName(2);
        Output_GetSubjectRootSegmentName object3_root_segment = this->vicon_client.GetSubjectRootSegmentName(object3_name.SubjectName);
        ...
        Output_GetSegmentGlobalTranslation object3_translation = this->vicon_client.GetSegmentGlobalTranslation(object3_name.SubjectName, object3_root_segment.SegmentName);
        Output_GetSegmentGlobalRotationQuaternion object3_rotation = this->vicon_client.GetSegmentGlobalRotationQuaternion(object3_name.SubjectName, object3_root_segment.SegmentName);
        ...
        pose_msg.position.set__x(object3_translation.Translation[0]/1000);
        pose_msg.position.set__y(object3_translation.Translation[1]/1000);
        pose_msg.position.set__z(object3_translation.Translation[2]/1000);

        pose_msg.orientation.set__x(object3_rotation.Rotation[0]);
        pose_msg.orientation.set__y(object3_rotation.Rotation[1]);
        pose_msg.orientation.set__z(object3_rotation.Rotation[2]);
        pose_msg.orientation.set__w(object3_rotation.Rotation[3]);

        object_publisher->publish(pose_msg);
