...
class CagingClient(Node):
    ...
    def activate_lqr(self):
        ...
        while not self.robot1_lqr_get_state_client.wait_for_service(1.0) and not self.robot2_lqr_get_state_client.wait_for_service(1.0):
    ...
    def deactivate_lqr(self):
        ...
        while not (self.robot1_lqr_get_state_client.wait_for_service(1.0) and self.robot2_lqr_get_state_client.wait_for_service(1.0)):
            self.get_logger().info("Waiting for LQR LifeCycle Nodes services...")
    ...
    def activate_caging_controller(self):
        ...
        while not self.robot2_caging_controller_get_state_client.wait_for_service(1.0):
